Thanks for showing interest to contribute to Chakra UI Extras 💖, you rock!
...
The following steps will get you up and running to contribute to Chakra UI Extras:

1. Fork the repo (click the <kbd>Fork</kbd> button at the top right of
   [this page](https://github.com/isBatak/chakra-ui-extras))

2. Clone your fork locally

```sh
git clone https://github.com/<your_github_username>/chakra-ui-extras.git
cd chakra-ui-extras
```
...
To improve our development process, we've set up tooling and systems. Chakra UI Extras
...
1. Fork of the chakra-ui-extras repository and clone your fork

2. Create a new branch out of the `main` branch. We follow the convention
   `[type/scope]`. For example `fix/headroom-hook` or `docs/menu-typo`. `type`
   can be either `docs`, `fix`, `feat`, `build`, or any other conventional
   commit type. `scope` is just a short id that describes the scope of work.

3. Make and commit your changes following the
   [commit convention](https://github.com/isBatak/chakra-ui-extras/blob/main/CONTRIBUTING.md#commit-convention).
...
By contributing your code to the chakra-ui-extras GitHub repository, you agree to
